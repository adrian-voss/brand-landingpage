...
A Claude Code skill that runs a structured brand discovery interview, generates iterative landing pages via Google Stitch, and delivers a deployment-ready HTML bundle.
